  ...
  <div class="row">
        ...
        <div class="card-header py-2">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('qrcode')?></h6>
                </div>
                                            ...
                                            <?php if ($counter == $cqty) { ?>
                                                ...
                                                <td class="barcode-toptd">      
                                                    ...
                                                    <div class="barcode-inner barcode-innerdiv">
                                                        ...
                                                        <img class="img-responsive center-block barcode-image" alt="" src="http://chart.apis.google.com/chart?cht=qr&chs=250x250&chl=<?php echo $product_id?>&chld=H|0" >
