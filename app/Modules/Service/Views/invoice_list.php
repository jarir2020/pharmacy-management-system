            ...
            <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-right">
                                   ...
                                   <a href="<?php echo base_url('service/service_invoice_form')?>" class="btn btn-success btn-sm mr-1"><i class="fas fa-plus mr-1"></i><?php echo lan('add_invoice')?></a>
                                 <?php }?>
                                </div>
                            </div>
                        </div>
            <div class="card-body">
             <div class="row">
                ...
                <div class="table-responsive">
                     <table class="table table-striped table-bordered custom-table" cellspacing="0" width="100%" id="ServiceInvoice"> 
                <thead>
                  <tr>
