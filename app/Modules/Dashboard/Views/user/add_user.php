            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('add_user')?></h6>
                </div>
                <div class="text-right">
                    <?php if($permission->method('user_list','read')->access()){?>  
                   <a href="<?php echo base_url('user/user_list')?>" class="btn btn-success btn-sm mr-1"><i class="fas fa-align-justify mr-1"></i><?php echo lan('user_list')?></a>
               <?php }?>
