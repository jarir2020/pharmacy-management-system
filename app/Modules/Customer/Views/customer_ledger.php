    ...
    <div class="col-md-12 col-md-12">
        <div class="card ">
            <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('customer_ledger')?></h6>
                                </div>
            ...
            <div class="card-body">
                  ...
                  <div class="col-sm-12">
                            ...
                            <?php echo form_open('customer/customer_ledger','class="form-inline"')?>
                            
                                            <div class="input-group mb-2 mr-sm-2 list-width">
                                               
                                                <?php echo  form_dropdown('customer_id',$customer_list,$customer_id, 'class="form-control select2" id="customer_id" ') ?> 
                                            </div>
        ...
        <table class="table" width="99%" align="center"  cellpadding="5" cellspacing="5" border="2"> 
                ...
                <tr align="center" class="">
                    ...
                    <td colspan="7"><font size="+1"> <strong ><?php echo lan('customer_ledger').'- '.$ledger[0]['HeadName'].' ('.lan('on')?> <span class="text-"><?php echo $dtpFromDate ?></span> <?php echo lan('to')?>  <span class="text"> <?php echo $dtpToDate;?></span>)</strong></font><strong></th></strong>
                </tr>
