        ...
        <div class="card ">
            <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('paid_customer')?></h6>
                                </div>
                               ...
                               <?php }?>
                                <?php if($permission->method('customer_list','read')->access()){?>  
                                   ...
                                   <a href="<?php echo base_url('customer/credit_customer')?>" class="btn btn-purple btn-sm"><i class="fas fa-align-justify mr-1"></i><?php echo lan('credit_customer')?></a>
                                   <?php }?>
                                </div>
                            </div>
                        </div>
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table display table-bordered table-striped table-hover custom-table" cellspacing="0" width="100%" id="CustomerListpaid">
                        <thead>
                            <tr>
