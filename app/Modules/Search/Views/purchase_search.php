        ...
        <div class="card ">
            <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('purchase_search')?></h6>
                                </div>
            ...
            <div class="card-body">
             <div class="row">
                  <div class="col-sm-4">
                            ...
                            <?php echo form_open('search/purchase_search')?>
           ...
           foreach($search_data as $result){?>
               <tr>
                <td><?php echo $sl++;?></td>
                 ...
                 <td><?php echo $result['chalan_no']?></td>
                 <td><?php echo $result['manufacturer_name']?></td>
                 <td><?php echo $result['grand_total_amount']?></td>
