        ...
        <div class="card ">
            <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('add_loan')?></h6>
                                </div>
                                <div class="text-right">
                                    <?php if($permission->method('loan_list','read')->access()){?>
                                   <a href="<?php echo base_url('loan/loan_list')?>" class="btn btn-success btn-sm mr-1"><i class="fas fa-align-justify mr-1"></i><?php echo lan('loan_list')?></a>
                               <?php }?>
            ...
            <div class="card-body">
                <?php echo  form_open_multipart('loan/save_loan') ?>
                                <div class="row">
                          <div class="col-sm-12">
