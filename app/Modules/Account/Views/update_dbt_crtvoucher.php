    ...
    <div class="card-header py-2">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('update_debit_voucher')?></h6>
            </div>
            <div class="text-right">
             ...
             <div class="card-body">
                    ...
                    <?php echo  form_open_multipart('account/update_debit_voucher','id="debit_voucher_form"') ?>
                     ...
                     <div class="form-group row">
                        <label for="ac" class="col-sm-2 col-form-label"><?php echo lan('credit_head') ?></label>
                        <div class="col-sm-4">
                          <select name="cmbDebit" id="cmbDebit" class="form-control select2">
                            ...
                            <option value="<?php echo $cracc->HeadCode;?>" <?php if($credit_info[0]['COAID'] == $cracc->HeadCode){
                              echo 'selected';
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                             <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker" value="<?php  echo $credit_info[0]['VDate'];?>">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="txtRemarks" class="col-sm-2 col-form-label"><?php echo lan('remark') ?></label>
                        <div class="col-sm-4">
                          <textarea  name="txtRemarks" id="txtRemarks" class="form-control"><?php  echo $credit_info[0]['Narration'];?></textarea>
                        </div>
                    </div> 
                   ...
                   <option value="<?php echo $acc1->HeadCode;?>"  <?php if($debitvoucher->COAID ==$acc1->HeadCode){
                    echo 'selected';
                         ...
                         <?php }?>
                                        ...
                                        <td><input type="text" name="txtAmount[]" value="<?php echo $debitvoucher->Debit;?>" class="form-control total_price text-right valid_number"  id="txtAmount_<?php echo $sl; ?>" onkeyup="dbtvouchercalculation(<?php echo $sl; ?>)" >
                                           </td>
                                       <td>
                                                 <button  class="btn btn-danger-soft red text-right" type="button" value="<?php echo lan('delete')?>" onclick="deleteRowdbtvoucher(this)"><i class="far fa-trash-alt"></i></button>
                                            </td>
                                    </tr>   
                                    <?php $sl++;} ?>                           
                             ...
                             <tfoot>
                                     ...
                                     <tr>
                                      <td >
                                        ...
                                        <td> <a id="add_more" class="btn btn-info" name="add_more"  onClick="addaccountdbt('debitvoucher')"><i class="fa fa-plus"></i></a>
                                         </td>
                                    </tr>
                                </tfoot>
                            </table>
