            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-right">
                 ...
                 <div class="card-body">
                         ...
                         <?php echo  form_open_multipart('account/save_contra_voucher','id="contra_voucher_form"') ?>
   ...
   <option value="<?php echo $acc1->HeadCode;?>"><?php echo $acc1->HeadName;?></option>
         <?php }?>
                                       ...
                                       <td>
                                                <button  class="btn btn-danger-soft red" type="button"  onclick="deleteRowContravoucher(this)"><i class="far fa-trash-alt"></i></button>
                                            </td>
                                    </tr>                              
