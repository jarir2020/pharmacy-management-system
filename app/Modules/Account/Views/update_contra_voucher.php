        ...
        <div class="card-header py-2">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('contra_voucher')?></h6>
                </div>
                <div class="text-right">
                 ...
                 <div class="card-body">
                      ...
                      <?php echo  form_open_multipart('account/update_contra_voucher','id="contra_voucher_form"') ?>
   ...
   <option value="<?php echo $acc1->HeadCode;?>" <?php if($vinfo['COAID'] == $acc1->HeadCode){echo 'selected';}?>><?php echo $acc1->HeadName;?></option>
         <?php }?>
                     ...
                     <td>
                              <button  class="btn btn-danger-soft red" type="button" onclick="deleteRowContravoucher(this)"><i class="fas fa-trash-alt"></i></button>
                      </td>
                                    </tr>   
                                    <?php $sl++;}?>                           
                    ...
                    <td class="text-right">
                     ...
                     <td class="text-right">
                      ...
                      <td><a id="add_more" class="btn btn-info-soft" name="add_more"  onClick="addaccountContravoucher('debitvoucher')"><i class="fa fa-plus"></i></a>
