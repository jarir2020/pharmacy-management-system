        ...
        <div class="card-header py-2">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('debit_voucher')?></h6>
                </div>
           ...
           <?php echo  form_open_multipart('account/save_debit_voucher','id="debit_voucher_form"') ?>
                     ...
                     <div class="form-group row">
                        <label for="ac" class="col-sm-2 col-form-label"><?php echo lan('credit_head')?><i class="text-danger">*</i></label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                       ...
                       <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="debtAccVoucher"> 
                                <thead>
                                    <tr>
                                        <th class="text-center"><?php echo lan('debit_head')?><i class="text-danger">*</i></th>
