 ...
 <div class="row">
        ...
        <div class="card-header py-2">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('cash_book')?></h6>
                </div>
                <?php 
      $PreBalance=0;
    if($previous)
    {
        ...
        $PreBalance=$PreBalance- $previous[0]['Debit'];
                ...
                ?>
                 ...
                 <div class="card-body">
            <?php echo form_open_multipart('account/cash_book','name="form1" id="form1" class="form-inline')?>        
                        <label class="sr-only" for="from_date"><?php echo lan('start_date') ?></label>
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control datepicker" name="from_date" id="from_date" placeholder="<?php echo lan('start_date') ?>" value="<?php echo esc($from_date)?>">
                                            </div>
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" class="form-control datepicker" id="to_date" name="to_date" placeholder="<?php echo lan('end_date') ?>" value="<?php echo esc($to_date)?>">
                         ...
                         foreach($oResult as $result){?>
                          <tr>
                            <?php
                                ...
                                ?>
                                <td align="center"><?php echo esc($result['Narration']);?></td>
                                 <td  align="right"><?php
