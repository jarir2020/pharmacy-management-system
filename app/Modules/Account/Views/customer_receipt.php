                        ...
                        <tr>
                            <td>
                                <table border="0" width="100%">
                                    <tbody>
                                        <tr>
                                         ...
                                         <tr>
                                            <td class="minpos-bordertop barcode-toptd" style="border-top: #333 1px solid;"></td>
                                        </tr>
                                        <tr>
                                            <td align="center"><b><?php echo $customer[0]['customer_name'];?></b><br /></td>
                                        </tr>
                                        <tr>
                                            <td align="center">
                                                <time datetime="2008-02-14 20:00">Mobile: <?php echo $customer[0]['customer_mobile'];?></time>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td align="center">
                                ...
                                <table width="100%" border="0">
                                    ...
                                    <tr>
                                    <td class="text-left"><?php echo lan('payment_type'); ?> : </td><td><?php echo  'Receive';?></td>
                                    </tr>
                                    <tr>
                                    <td class="text-left"><?php echo lan('amount'); ?> </td><td>: <?php echo  $payment_info[0]['Credit'];?></td>
                                    </tr>
                                     <tr>
